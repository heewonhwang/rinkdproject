package com.example.rinkdproject.Hcoffee.Hamericano;
...
public class HAmeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final HAmeActivity.PagerAdapter adapter = new HAmeActivity.PagerAdapter
    ...
    private class PagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    HAmeFragment tab1 = new HAmeFragment();
                    return tab1;
                default:
                    return null;
            }
