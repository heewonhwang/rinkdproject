package com.example.rinkdproject.Hbeverage.Hsweetpotatolatte;
...
public class HSweetpotatoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final HSweetpotatoActivity.PagerAdapter adapter = new HSweetpotatoActivity.PagerAdapter
