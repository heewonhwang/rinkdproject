...
public class PalgongActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(R.drawable.palgong);
        ...
        final PalgongActivity.PagerAdapter adapter = new PalgongActivity.PagerAdapter
