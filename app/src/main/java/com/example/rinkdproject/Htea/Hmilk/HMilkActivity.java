package com.example.rinkdproject.Htea.Hmilk;
...
public class HMilkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final HMilkActivity.PagerAdapter adapter = new HMilkActivity.PagerAdapter
    ...
    private class PagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    BlackFragment tab1 = new BlackFragment();
                    return tab1;
                case 1:
                    TaroFragment tab2 = new TaroFragment();
                    return tab2;
                case 2:
                    ChocoFragment tab3 = new ChocoFragment();
                    return tab3;
                case 3:
