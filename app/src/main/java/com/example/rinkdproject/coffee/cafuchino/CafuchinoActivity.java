package com.example.rinkdproject.coffee.cafuchino;
...
public class CafuchinoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("카푸치노"));


        tabLayout.setTabGravity(tabLayout.GRAVITY_FILL);

        final ViewPager viewpager = (ViewPager) findViewById(R.id.viewPager);
        final CafuchinoActivity.PagerAdapter adapter = new CafuchinoActivity.PagerAdapter
    ...
    private class PagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    CafuchinoFragment tab1 = new CafuchinoFragment();
                    return tab1;
                default:
                    return null;
            }
