package com.example.rinkdproject.Hcoffee.Hcafuchino;
...
public class HCafuchinoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final HCafuchinoActivity.PagerAdapter adapter = new HCafuchinoActivity.PagerAdapter
    ...
    private class PagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    HCafuFragment tab1 = new HCafuFragment();
                    return tab1;
                default:
                    return null;
            }
