...
public class JambaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(R.drawable.jamba);
        ...
        final JambaActivity.PagerAdapter adapter = new JambaActivity.PagerAdapter
