...
public class TwosomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(R.drawable.twosomeplace);
        ...
        final TwosomeActivity.PagerAdapter adapter = new TwosomeActivity.PagerAdapter
