package com.example.rinkdproject.Hbeverage.Hsugar;
...
import com.example.rinkdproject.Hbeverage.Hgreentealatte.GreenteaFragment;
...
public class HSugerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final HSugerActivity.PagerAdapter adapter = new HSugerActivity.PagerAdapter
    ...
    private class PagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    SugarFragment tab1 = new SugarFragment();
                    return tab1;
                default:
                    return null;
            }
