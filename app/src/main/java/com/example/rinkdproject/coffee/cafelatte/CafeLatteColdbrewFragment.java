...
public class CafeLatteColdbrewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        query =FirebaseDatabase.getInstance().getReference().child("Latte").child("ColdbrewLatte").orderByChild("price");
