...
public class CafeLatteTiramisuFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        query =FirebaseDatabase.getInstance().getReference().child("Latte").child("TiramisuLatte").orderByChild("price");
