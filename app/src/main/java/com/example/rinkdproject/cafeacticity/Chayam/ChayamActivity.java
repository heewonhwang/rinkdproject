...
public class ChayamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(R.drawable.chayam);
        ...
        final ChayamActivity.PagerAdapter adapter = new ChayamActivity.PagerAdapter
