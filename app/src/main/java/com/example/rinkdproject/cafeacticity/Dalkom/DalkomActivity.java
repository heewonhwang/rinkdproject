...
public class DalkomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(R.drawable.dalkom);
        ...
        final DalkomActivity.PagerAdapter adapter = new DalkomActivity.PagerAdapter
