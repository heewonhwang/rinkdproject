...
public class HoichaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(R.drawable.hoicha);
        ...
        final HoichaActivity.PagerAdapter adapter = new HoichaActivity.PagerAdapter
