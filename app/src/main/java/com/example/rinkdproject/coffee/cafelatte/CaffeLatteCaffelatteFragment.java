...
public class CaffeLatteCaffelatteFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        query =FirebaseDatabase.getInstance().getReference().child("Latte").child("CafeLatte").orderByChild("price");
