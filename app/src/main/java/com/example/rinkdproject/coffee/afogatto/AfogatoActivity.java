package com.example.rinkdproject.coffee.afogatto;
...
public class AfogatoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("아포가토"));


        tabLayout.setTabGravity(tabLayout.GRAVITY_FILL);

        final ViewPager viewpager = (ViewPager) findViewById(R.id.viewPager);
        final AfogatoActivity.PagerAdapter adapter = new AfogatoActivity.PagerAdapter
    ...
    private class PagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    AfogatoFragment tab1 = new AfogatoFragment();
                    return tab1;
                default:
                    return null;
            }
