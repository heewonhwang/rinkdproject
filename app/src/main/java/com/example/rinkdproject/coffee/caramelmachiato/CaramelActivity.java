package com.example.rinkdproject.coffee.caramelmachiato;
...
public class CaramelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final CaramelActivity.PagerAdapter adapter = new CaramelActivity.PagerAdapter
    ...
    private class PagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    CaramelFragment tab1 = new CaramelFragment();
                    return tab1;
                default:
                    return null;
            }
