package com.example.rinkdproject.Hbeverage.Hchocolatte;
...
public class HChocoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final HChocoActivity.PagerAdapter adapter = new HChocoActivity.PagerAdapter
    ...
    private class PagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    com.example.rinkdproject.Hbeverage.Hchocolatte.ChocoFragment tab1 = new ChocoFragment();
                    return tab1;
                case 1:
                    WhiteChocoFragment tab2 = new WhiteChocoFragment();
                    return tab2;
                case 2:
                    MintFragment tab3 = new MintFragment();
                    return tab3;
                case 3:
                   CinnamonFragment tab4 = new CinnamonFragment();
                    return tab4;
                default:
                    return null;
            }
