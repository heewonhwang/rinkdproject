...
public class StarbucksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final StarbucksActivity.PagerAdapter adapter = new StarbucksActivity.PagerAdapter
    ...
    private class PagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    com.example.rinkdproject.cafeacticity.Starbucks.menuFragment tab1 = new menuFragment();
                    return tab1;
                /*case 1:
