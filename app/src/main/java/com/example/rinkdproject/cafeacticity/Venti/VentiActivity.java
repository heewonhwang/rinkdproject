...
public class VentiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(R.drawable.venti);
        ...
        final VentiActivity.PagerAdapter adapter = new VentiActivity.PagerAdapter
