package com.example.rinkdproject.Hcoffee.Heinspanner;
...
public class HEinspanner extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final HEinspanner.PagerAdapter adapter = new HEinspanner.PagerAdapter
    ...
    private class PagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    HEinsFragment tab1 = new HEinsFragment();
                    return tab1;
                default:
                    return null;
            }
