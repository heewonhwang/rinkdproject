package com.example.rinkdproject.Hjuice;
...
public class HJuiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("주스"));

        tabLayout.setTabGravity(tabLayout.GRAVITY_FILL);

        final ViewPager viewpager = (ViewPager) findViewById(R.id.viewPager);
        final HJuiceActivity.PagerAdapter adapter = new HJuiceActivity.PagerAdapter
    ...
    private class PagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    JuiceFragment tab1 = new JuiceFragment();
                    return tab1;
                default:
                    return null;
            }
