package com.example.rinkdproject.Hcoffee.Hvanilalatte;
...
public class HVanilaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final HVanilaActivity.PagerAdapter adapter = new HVanilaActivity.PagerAdapter
    ...
    private class PagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    HVanilaFragment tab1 = new HVanilaFragment();
                    return tab1;
                default:
                    return null;
            }
