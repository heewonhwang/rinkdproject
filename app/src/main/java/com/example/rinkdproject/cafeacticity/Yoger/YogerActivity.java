...
public class YogerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(R.drawable.yoger);
        ...
        final YogerActivity.PagerAdapter adapter = new YogerActivity.PagerAdapter
