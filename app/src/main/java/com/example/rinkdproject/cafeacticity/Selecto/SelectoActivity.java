...
public class SelectoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(R.drawable.selecto);
        ...
        final SelectoActivity.PagerAdapter adapter = new SelectoActivity.PagerAdapter
