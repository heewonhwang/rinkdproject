package com.example.rinkdproject.coffee.vanilalatte;
...
public class VanilaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("바닐라 라떼"));

        tabLayout.setTabGravity(tabLayout.GRAVITY_FILL);

        final ViewPager viewpager = (ViewPager) findViewById(R.id.viewPager);
        final VanilaActivity.PagerAdapter adapter = new VanilaActivity.PagerAdapter
    ...
    private class PagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    VanilaLatteFragment tab1 = new VanilaLatteFragment();
                    return tab1;
                default:
                    return null;
            }
