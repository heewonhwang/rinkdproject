package com.example.rinkdproject.coffee.decaffein;
...
public class DecaffeinActicity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("디카페인"));

        tabLayout.setTabGravity(tabLayout.GRAVITY_FILL);

        final ViewPager viewpager = (ViewPager) findViewById(R.id.viewPager);
        final DecaffeinActicity.PagerAdapter adapter = new DecaffeinActicity.PagerAdapter
    ...
    private class PagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    decaffeinFragment tab1 = new decaffeinFragment();
                    return tab1;
                default:
                    return null;
            }
