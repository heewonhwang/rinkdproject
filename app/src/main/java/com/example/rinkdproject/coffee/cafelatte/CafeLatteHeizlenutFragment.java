...
public class CafeLatteHeizlenutFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        query =FirebaseDatabase.getInstance().getReference().child("Latte").child("HeyzlenutLatte").orderByChild("price");
